package com.pika.videoplayerapp;
...
import com.pika.videoplayerapp.services.CustomOnScaleGestureListener;
import com.pika.videoplayerapp.services.PinchListener;
import com.pika.videoplayerapp.util.Widget;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mExoRotate.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void createPipAction(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            final ArrayList<RemoteAction> actions = new ArrayList<RemoteAction>();
            Intent actionIntent = new Intent("com.pika.videoplayerapp.PLAY_PAUSE");
    ...
    public void onPictureInPictureModeChanged(boolean isInPictureInPicture,
        ...
        super.onPictureInPictureModeChanged(isInPictureInPicture);
        if (isInPictureInPicture){
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                ...
                filter.addAction("com.pika.videoplayerapp.PLAY_PAUSE");
